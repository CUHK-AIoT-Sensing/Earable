import torch
from utils.conditional_dataset import Conditional_SpeechEnhancementDataset
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', type=str, default='tfgridnet_embed_condition', help='Configuration name for the experiment')
    ...
    dataset = Conditional_SpeechEnhancementDataset(dataset=vib_dataset, noise_folders=config['noise_dataset'], rir=config['rir'],
