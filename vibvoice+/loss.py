...
def eval(clean, predict):
    ...
    pesq_wb = pesq_batch(16000, clean_npy, predict_npy, 'wb', on_error=PesqError.RETURN_VALUES)
    pesq_nb = pesq_batch(16000, clean_npy, predict_npy, 'nb', on_error=PesqError.RETURN_VALUES)
