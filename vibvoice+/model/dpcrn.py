...
class DPCRN(nn.Module):
    ...
    """
    def __init__(self, channel_list = [16, 32, 64, 128, 256], single_modality=False, real_imag=False, early_fusion=False, add=True, pad_num=1, last_channel=1, last_act=True):
