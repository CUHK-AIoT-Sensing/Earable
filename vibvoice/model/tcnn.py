...
class TCNN(nn.Module):
    def __init__(self):
        ...
        self.TCNN_Block_1 = TCNN_Block(in_channels=576, out_channels=512, kernel_size=3, init_dilation=2, num_layers=6)
        self.TCNN_Block_2 = TCNN_Block(in_channels=576, out_channels=512, kernel_size=3, init_dilation=2, num_layers=6)
        self.TCNN_Block_3 = TCNN_Block(in_channels=576, out_channels=512, kernel_size=3, init_dilation=2, num_layers=6)
    ...
    def forward(self, input):
        # input = input.reshape(input.shape[0], 1, -1, 320)
        input = input.unfold(-1, 640, 320)
